...
@RestController
@RequestMapping("/jobc")
@Api(produces = "application/json", value = "Operations pertaining to manage jobs in the application")
...
public ResponseEntity<String> updateJob(@PathVariable(value="id") Long id,@Valid @RequestBody JobModel job) throws ResourceNotFoundException {
